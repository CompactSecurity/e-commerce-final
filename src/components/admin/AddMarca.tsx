...
const AddMarcas = ({ onBack }: AddMarcasProps) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            Object.entries(marcaData).forEach(([key, value]) => {
            ...
            const response = await fetch('http://localhost/e-commerce/api/marcas/create', {
                method: 'POST',
                credentials: 'include',
                body: formData,
            });
            ...
            if (data.status === 'success') {
                ...
                alert(data.mensaje || 'Error al crear la marca');
            }
        } catch (error) {
