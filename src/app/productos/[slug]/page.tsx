        ...
        <>
            ...
            <main className="min-h-screen bg-gray-50 pt-[70px]">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div className="bg-gray md:bg-gray rounded-xl overflow-hidden md:shadow-none shadow-lg md:bg-transparent bg-white">
                ...
                {relatedProducts.length > 0 && (
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                        <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">Productos relacionados</h2>
